...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">修改角色 <small>Modify Role</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{url('admin/role',$roleInfo->id)}}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="name">角色 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="name" placeholder="角色" data-parsley-required="true" data-parsley-required-message="请输入角色名称（英文）" value="{{$roleInfo->name}}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="description" placeholder="描述" data-parsley-required="true" data-parsley-required-message="请输入角色描述" value="{{$roleInfo->description}}"/>
                                </div>
                            </div>
