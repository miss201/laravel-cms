            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/menu') }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="url" placeholder="菜单链接" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="is_menu">是否是菜单 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input  type="radio" name="is_menu" value="1"/>是
                                    <input  type="radio" name="is_menu" vlaue="0" />否
                                </div>
                            </div>
